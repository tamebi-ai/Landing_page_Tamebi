      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-500 h-full flex flex-col">
                ...
                <button 
                  ...
                  className="w-full bg-black text-white hover:bg-gray-800 group-hover:bg-yellow-400 group-hover:text-black transition-all duration-300 rounded-xl px-8 py-4 text-lg mt-auto"
                >
                  En savoir plus
                </button>
              </div>
        ...
        >
          <div className="bg-gradient-to-r from-black via-gray-800 to-black rounded-3xl p-12">
            ...
            <button 
              onClick={scrollToContact}
              className="bg-yellow-400 text-black hover:bg-yellow-300 font-semibold px-8 py-4 rounded-full text-lg"
            >
